...
namespace Photon.Pun
{
    ...
    public class PhotonRigidbodyView : MonoBehaviour, IPunObservable
    {
        ...
        public void FixedUpdate()
        {
            ...
            {
                this.m_Body.position = Vector3.MoveTowards(this.m_Body.position, this.m_NetworkPosition, this.m_Distance * (1f / PhotonNetwork.SerializationRate));
                this.m_Body.rotation = Quaternion.RotateTowards(this.m_Body.rotation, this.m_NetworkRotation, this.m_Angle * (1f / PhotonNetwork.SerializationRate));
            }
        }
